...
> 6/6 Reporting a problem? The new Logs menu opens existing journals and exports a local diagnostics ZIP with version details and log tails. Nothing is uploaded automatically. Logs may contain player IDs or IP addresses: review them before sharing.
